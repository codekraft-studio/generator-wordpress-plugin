...
module.exports = class extends BaseGenerator {
  ...
  prompting() {
    return super.prompting([ {
      type: 'input',
      name: 'page_title',
      message: 'What is the posts page title?',
      default: _.upperFirst(this.options.name)
    },{
      type: 'input',
      name: 'menu_title',
      message: 'What is the posts page menu title?',
      default: answers => _.upperFirst(answers.page_title)
    }, {
      type: 'input',
      name: 'capability',
      message: 'What is the posts page capability?',
      default: "administrator"
    }, {
      type: 'input',
      name: 'menu_slug',
      message: 'What is the posts page menu unique slug?',
