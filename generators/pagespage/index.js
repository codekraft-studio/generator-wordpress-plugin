...
module.exports = class extends BaseGenerator {
  ...
  prompting() {
    return super.prompting([{
      type: 'input',
      name: 'page_title',
      message: 'What is the pages page title?',
      default: answers => _.upperFirst(answers.name || this.options.name)
    },{
      type: 'input',
      name: 'menu_title',
      message: 'What is the pages page menu title?',
      default: answers => _.upperFirst(answers.page_title)
    }, {
      type: 'input',
      name: 'capability',
      message: 'What is the pages page capability?',
      default: "administrator"
    }, {
      type: 'input',
      name: 'menu_slug',
      message: 'What is the pages page menu unique slug?',
