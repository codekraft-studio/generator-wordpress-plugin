...
module.exports = class extends WPGenerator {
  ...
  prompting() {
    return this.prompt([ {
      type: 'input',
      name: 'page_title',
      message: 'What is the users page title?',
      default: _.upperFirst(this.options.name)
    },{
      type: 'input',
      name: 'menu_title',
      message: 'What is the users page menu title?',
      default: answers => _.upperFirst(answers.page_title)
    }, {
      type: 'input',
      name: 'capability',
      message: 'What is the users page capability?',
      default: "administrator"
    }, {
      type: 'input',
      name: 'menu_slug',
      message: 'What is the users page menu unique slug?',
