...
module.exports = class extends BaseGenerator {
  ...
  prompting() {
    return super.prompting([ {
      type: 'input',
      name: 'page_title',
      message: 'What is the plugins page title?',
      default: answers => _.upperFirst(answers.name || this.options.name)
    },{
      type: 'input',
      name: 'menu_title',
      message: 'What is the plugins page menu title?',
      default: answers => _.upperFirst(answers.page_title)
    }, {
      type: 'input',
      name: 'capability',
      message: 'What is the plugins page capability?',
      default: "administrator"
    }, {
      type: 'input',
      name: 'menu_slug',
      message: 'What is the plugins page menu unique slug?',
